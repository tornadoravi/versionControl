...
var enterid = "b1E35P"
var checkyear = "2021"
var checkfeatures = "stored"
var checkVersionName = "iOS 15.4.1"

//   id     ************************************************************************************************************************************** */
console.log("id :", enterid)
bugids = bugidList.filter(n => n.id.includes(enterid))
console.log("correct::", bugids)
console.log("*************************************************************************************************************************")
// year     **************************************************************************************************************************************
console.log("year :", checkyear)
console.log("*************************************************************************************************************************")
cheackyear = updateList.filter(n => (n.releseDate).slice(-4).includes(checkyear))
console.log(cheackyear)
console.log("*************************************************************************************************************************")
//features    ****************************************************************************************************************************************
...
for (j of updateList) {
    ...
    if (j.features[0].split(' ').includes(checkfeatures)) {
        console.log(j.versionName)
    }
}
console.log("*************************************************************************************************************************")
//max author    *******************************************************************************************************************************************
...
console.log("*************************************************************************************************************************")
checkVersionNames = updateList.filter(n => n.versionName.includes(checkVersionName))
console.log(checkVersionNames)
console.log("*************************************************************************************************************************")
//type      **********************************************************************************************************************************************
console.log("type :", checkType)
console.log("*************************************************************************************************************************")
checkUpdate = updateList.filter(n => n.type.includes(checkType))
